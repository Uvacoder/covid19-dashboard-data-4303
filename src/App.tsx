  ...
  return (
    <div className="App">
      <header className='appHeader'>
        <h1 className='headerTitle'>COVID 19 Dashboard<span className="headerSubNote">A great Covid19 dashboard with data from <a href="https://github.com/uvacoder" rel="noopener noreferrer" target="_blank"><img src={ChilicornLogo} alt='Chilicorn Logo' className='chilicornLogo'/></span></a></h1>
          <div className='icons'>
